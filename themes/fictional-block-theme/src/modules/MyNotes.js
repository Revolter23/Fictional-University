...
class MyNotes {
	...
	makeNoteEditable(thisNote) {
		...
		thisNote.setAttribute(
			"data-title",
			thisNote.querySelector(".note-title-field").value
		);
		thisNote.setAttribute(
			"data-body",
			thisNote.querySelector(".note-body-field").value
		);
	}
	...
	cancelNoteEdit(thisNote) {
		thisNote.querySelector(".note-title-field").value =
			thisNote.getAttribute("data-title");
		thisNote.querySelector(".note-body-field").value =
			thisNote.getAttribute("data-body");
	}
