...
/* harmony import */ var _modules_MobileMenu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/MobileMenu.js */ "./src/modules/MobileMenu.js");
/* harmony import */ var _modules_HeroSlider_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/HeroSlider.js */ "./src/modules/HeroSlider.js");
...
/* harmony import */ var _modules_MyNotes_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/MyNotes.js */ "./src/modules/MyNotes.js");
...
var mobileMenu = new _modules_MobileMenu_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
var heroSlider = new _modules_HeroSlider_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const search = new _modules_Search_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const myNotes = new _modules_MyNotes_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const like = new _modules_Like_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
class MyNotes {
  ...
  makeNoteEditable(thisNote) {
    ...
    thisNote.setAttribute("data-title", thisNote.querySelector(".note-title-field").value);
    thisNote.setAttribute("data-body", thisNote.querySelector(".note-body-field").value);
  }
  ...
  cancelNoteEdit(thisNote) {
    thisNote.querySelector(".note-title-field").value = thisNote.getAttribute("data-title");
    thisNote.querySelector(".note-body-field").value = thisNote.getAttribute("data-body");
  }
  async deleteNote(e) {
    const thisNote = this.findNearestParentLi(e.target);
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].delete(universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"));
  ...
  async updateNote(e) {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(universityData.root_url + "/wp-json/wp/v2/note/" + thisNote.getAttribute("data-id"), ourUpdatedPost);
      this.makeNoteReadOnly(thisNote);
    } catch (e) {
      console.log("Sorry");
    }
  ...
  async createNote() {
    ...
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(universityData.root_url + "/wp-json/wp/v2/note/", ourNewPost);
...
// 		thisNote.data("title", thisNote.find(".note-title-field").val());
// 		thisNote.data("body", thisNote.find(".note-body-field").val());
// 	}
...
// 	cancelNoteEdit(thisNote) {
// 		thisNote.find(".note-title-field").val(thisNote.data("title"));
// 		thisNote.find(".note-body-field").val(thisNote.data("body"));
// 	}
...
// 			error: (response) => {
// 				if (
// 					response.responseText == "You have reached your note limit."
// 				) {
...
class Search {
  ...
  async getResults() {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(universityData.root_url + "/wp-json/university/v1/search?term=" + this.searchField.value);
